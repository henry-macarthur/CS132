...
public class Context {
    ...
    Hashtable<String, Integer> label_to_line = 
        new Hashtable<String, Integer>();
    Hashtable<String, Hashtable<String, Integer>> method_int = 
    ...
    public void load_int() {
        ...
        for(String id : ids) {
            int ind = id.indexOf("_");
            String method = id.substring(0, ind);

            if(!method_int.containsKey(method)) {
                Hashtable<String, Integer> tmp = new Hashtable<String, Integer>();
                method_int.put(method, tmp);
            }
            Hashtable<String, Integer> tmp =  method_int.get(method);
            tmp.put(id, id_to_start.get(id));
            method_int.put(method, tmp);
        }
    }
    ...
    public ArrayList<String> getLiveIntervals(int cur_line, String method_name) {
        ArrayList<String> live_intervals = new ArrayList<String>();
        Set<String> ids = method_int.get(method_name).keySet();//id_to_start.keySet();
    ...
    public void allocateRegister(int line_number, String method_name) {
        ...
        increasingStart = getLiveIntervals(line_number, method_name);
    ...
    public String getRegister(String id, int line_number) {
        ...
        String method_name = id.substring(0, id.indexOf("_"));
        allocateRegister(line_number, method_name); //this handles register allocation 
